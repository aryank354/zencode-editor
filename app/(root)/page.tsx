  ...
  return (
    <div className=" z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
      ...
      <p className="mt-2 text-lg text-center text-gray-600 dark:text-gray-400 px-5 py-10 max-w-2xl">
        Zen Code Editor is a modern, intelligent editor built to elevate your coding experience. 
        It offers smart features, smooth integrations, and powerful tools that help you write, debug, and optimize code effortlessly.
